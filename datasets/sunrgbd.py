...
class SunRGBD(Dataset):
    ...
    num_classes: 37
    """
    CLASSES = ['wall', 'floor', 'cabinet', 'bed', 'chair', 'sofa', 'table', 'door', 'window', 'bookshelf', 'picture', 'counter', 'blinds', 'desk', 'shelves', 'curtain', 'dresser', 'pillow', 'mirror', 
...
if __name__ == '__main__':
    ...
    root = 'C:\\Users\\sithu\\Documents\\Datasets\\sunrgbd'
    transform = Compose([RandomResizedCrop((512, 512)), Normalize()])

    dataset = SunRGBD(root, split="val", transform=transform)
